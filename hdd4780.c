...
static hdd4780_err_t hdd4780_bus_initialize(hdd4780_t const *hdd4780) {
  assert(hdd4780);

  if (hdd4780->interface.bus_initialize) {
    return hdd4780->interface.bus_initialize(hdd4780->interface.bus_user);
  }

  return HDD4780_ERR_NULL;
}

static hdd4780_err_t hdd4780_bus_deinitialize(hdd4780_t const *hdd4780) {
  assert(hdd4780);

  if (hdd4780->interface.bus_deinitialize) {
    return hdd4780->interface.bus_deinitialize(hdd4780->interface.bus_user);
  }
...
hdd4780_err_t hdd4780_initialize(hdd4780_t *hdd4780,
  ...
  return hdd4780_bus_initialize(hdd4780);
}

hdd4780_err_t hdd4780_deinitialize(hdd4780_t *hdd4780) {
  assert(hdd4780);

  hdd4780_err_t err = hdd4780_bus_deinitialize(hdd4780);
...
hdd4780_err_t hdd4780_display_frame_buf(hdd4780_t *hdd4780) {
  ...
  return hdd4780_bus_transmit(hdd4780, hdd4780->frame_buf,
                              sizeof(hdd4780->frame_buf));
}
...
hdd4780_err_t hdd4780_send_function_set_cmd(hdd4780_t const *hdd4780,
                                            uint8_t dl, uint8_t n, uint8_t f) {
  assert(hdd4780);
